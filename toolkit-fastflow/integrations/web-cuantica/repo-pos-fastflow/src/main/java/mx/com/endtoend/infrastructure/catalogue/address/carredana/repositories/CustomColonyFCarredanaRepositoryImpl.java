...
@Repository
public class CustomColonyFCarredanaRepositoryImpl implements CustomColonyFCarRepository {

    private final Logger LOG = LoggerFactory.getLogger(CustomColonyFCarredanaRepositoryImpl.class);
    @Autowired
    @Qualifier("carredanaDataEntityManagerFactory")
    EntityManager em;

    public CustomColonyFCarredanaRepositoryImpl(EntityManager entityManager) {
