...
@Repository
public class CustomColonyFSamanoRepositoryImpl implements CustomColonyFSamanoRepository {

    private final Logger LOG = LoggerFactory.getLogger(CustomColonyFSamanoRepositoryImpl.class);
    @Autowired
    @Qualifier("ferresamanoDataEntityManagerFactory")
    EntityManager em;

    public CustomColonyFSamanoRepositoryImpl(EntityManager entityManager) {
