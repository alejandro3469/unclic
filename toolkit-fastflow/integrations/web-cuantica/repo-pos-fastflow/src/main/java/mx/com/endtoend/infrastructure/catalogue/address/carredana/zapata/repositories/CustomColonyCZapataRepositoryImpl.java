...
@Repository
public class CustomColonyCZapataRepositoryImpl implements CustomColonyCZapataRepository {

    private final Logger LOG = LoggerFactory.getLogger(CustomColonyCZapataRepositoryImpl.class);
    @Autowired
    @Qualifier("zapataDataEntityManagerFactory")
    EntityManager em;

    public CustomColonyCZapataRepositoryImpl(EntityManager entityManager) {
