package mx.com.endtoend.infrastructure.services.jde.catalogue.demo.common.repository.impl;
...
import mx.com.endtoend.infrastructure.services.jde.catalogue.demo.common.entities.QF0117;
import mx.com.endtoend.infrastructure.services.jde.catalogue.demo.common.entities.QF0118;
import mx.com.endtoend.infrastructure.services.jde.catalogue.demo.common.repository.CustomDirectionFDemoRepository;

@Repository
@ConditionalOnProperty(name = "app.demo.oracle.enabled", havingValue = "true", matchIfMissing = false)
public class CustomDirectionFDemoRepositoryImpl implements CustomDirectionFDemoRepository {

    private final Logger LOG = LoggerFactory.getLogger(CustomDirectionFDemoRepositoryImpl.class);
    @Autowired
    @Qualifier("demoOracleEntityManagerFactory")
    EntityManager em;

    public CustomDirectionFDemoRepositoryImpl(EntityManager entityManager) {
