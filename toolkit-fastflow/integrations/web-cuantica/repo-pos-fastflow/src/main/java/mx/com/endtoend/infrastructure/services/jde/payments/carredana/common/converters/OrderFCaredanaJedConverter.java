package mx.com.endtoend.infrastructure.services.jde.payments.carredana.common.converters;
...
import mx.com.endtoend.infrastructure.services.jde.payments.carredana.common.entities.F47012Id;
...
@Component
public class OrderFCaredanaJedConverter {
	...
	public F47011 orderDtoToF47011(OrderDto orderDto, BigDecimal an8Branch) {
		...
		f47011.setSycrr(orderDto.getExchangeRate().multiply(BigDecimal.valueOf(100)).longValue());
	...
	public F47012 orderDetailDtoToF47012(OrderDetailDto orderDetailDto, OrderDto orderDto) {
		...
		f47012.setSzsoqs(orderDetailDto.getRequestAmount().multiply(BigDecimal.valueOf(1000)).longValue());
		...
		f47012.setSzuprc(orderDetailDto.getFinalUnitPrice().multiply(BigDecimal.valueOf(10000)).longValue());
		f47012.setSzdct("");
		...
		f47012.setSzuorg(orderDetailDto.getRequestAmount().multiply(BigDecimal.valueOf(1000)).longValue());
		f47012.setSzurcd("CP");
		f47012.setSzurdt(0L);
		f47012.setSzurat(0L);
		f47012.setSzurab(urab);
		f47012.setSzurrf("               ");
		f47012.setSzogno(orderDetailDto.getRequestAmount().multiply(BigDecimal.valueOf(1000)).longValue());
