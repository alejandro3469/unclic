package mx.com.endtoend.infrastructure.services.jde.clients.calzada.business;
...
import mx.com.endtoend.infrastructure.services.jde.clients.calzada.entities.F01151;
...
import mx.com.endtoend.infrastructure.services.jde.clients.calzada.entities.F0115Z1;
import mx.com.endtoend.infrastructure.services.jde.clients.calzada.entities.F0115Z1Id;
...
import mx.com.endtoend.infrastructure.services.jde.clients.calzada.repository.F0002Repository;
import mx.com.endtoend.infrastructure.services.jde.clients.calzada.repository.F0101Repository;
import mx.com.endtoend.infrastructure.services.jde.clients.calzada.repository.F0101Z2Repository;
import mx.com.endtoend.infrastructure.services.jde.clients.calzada.repository.F0111Repository;
import mx.com.endtoend.infrastructure.services.jde.clients.calzada.repository.F0111Z1Repository;
import mx.com.endtoend.infrastructure.services.jde.clients.calzada.repository.F01151Repository;
import mx.com.endtoend.infrastructure.services.jde.clients.calzada.repository.F01151Z1Repository;
import mx.com.endtoend.infrastructure.services.jde.clients.calzada.repository.F0115Repository;
import mx.com.endtoend.infrastructure.services.jde.clients.calzada.repository.F0115Z1Repository;
...
import mx.com.endtoend.infrastructure.services.jde.clients.calzada.repository.F03012Z1Repository;
...
public class HardwareStoreOracleRepository implements ClientOracleRepository {

	private static final String REFERENCE_SM = "SMARTB";

	private final Logger LOG = LoggerFactory.getLogger(HardwareStoreOracleRepository.class);

	@Autowired
	private F0101Z2Repository f0101z2Repository;
	@Autowired
	private F01151Z1Repository f01151z1Repository;
	@Autowired
	private F0115Z1Repository f0115z1Repository;
	@Autowired
	private F03012Z1Repository f03012z1Repository;
	@Autowired
	private F0002Repository f0002Repository;
	@Autowired
	private F0101Repository f0101Repository;
	@Autowired
	private F0116Repository f0116Repository;
	@Autowired
	private F0115Repository f0115Repository;
	@Autowired
	private F01151Repository f01151Repository;
	@Autowired
	private F03012Repository f03012Repository;
	@Autowired
	private F0111Repository f0111Repository;
	@Autowired
	private F0111Z1Repository f0111z1Repository;
	@Autowired
