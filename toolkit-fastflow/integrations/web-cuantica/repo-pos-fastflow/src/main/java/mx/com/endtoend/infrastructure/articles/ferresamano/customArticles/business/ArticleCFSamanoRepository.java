package mx.com.endtoend.infrastructure.articles.ferresamano.customArticles.business;
...
import mx.com.endtoend.infrastructure.articles.ferresamano.oracle.converters.ArticleConvertionFactorFerresamanoConverter;
import mx.com.endtoend.infrastructure.articles.ferresamano.oracle.entities.F4008;
import mx.com.endtoend.infrastructure.articles.ferresamano.oracle.entities.F41002;
import mx.com.endtoend.infrastructure.articles.ferresamano.oracle.entities.F4102;
import mx.com.endtoend.infrastructure.articles.ferresamano.oracle.entities.F4104;
import mx.com.endtoend.infrastructure.articles.ferresamano.oracle.repositories.CustomDslArticleFerresamanoRepositoryImpl;
import mx.com.endtoend.infrastructure.articles.ferresamano.oracle.repositories.F4008FerresamanoRepository;
import mx.com.endtoend.infrastructure.articles.ferresamano.oracle.repositories.F41002FerresamanoRepository;
import mx.com.endtoend.infrastructure.articles.ferresamano.oracle.repositories.F41021FerresamanoRepository;
import mx.com.endtoend.infrastructure.articles.ferresamano.oracle.repositories.F4102FerresamanoRepository;
import mx.com.endtoend.infrastructure.articles.ferresamano.oracle.repositories.F4104FerresamanoRepository;
import mx.com.endtoend.infrastructure.articles.ferresamano.oracle.repositories.F4106FerresamanoRepository;
...
@Service
public class ArticleCFSamanoRepository implements GenericArticleRepository {

	@Autowired
	private DebugServicePort debugServicePort;

	@Autowired(required = false)
	private F4102FerresamanoRepository f4102Repository;

	@Autowired(required = false)
	private F41021FerresamanoRepository f41021Repository;

	@Autowired(required = false)
	private F0005FFerresamanoRepository f0005Repository;

	@Autowired(required = false)
	private F41002FerresamanoRepository f41002Repository;

	@Autowired(required = false)
	private F4106FerresamanoRepository f4106Repository;

	@Autowired(required = false)
	private F4008FerresamanoRepository f4008Repository;

	@Autowired(required = false)
	private F4104FerresamanoRepository f4104Repository;
	...
	@Autowired(required = false)
	private CustomDslArticleFerresamanoRepositoryImpl customDslArticleRepositoryImpl;

	@Autowired(required = false)
	private ArticleConvertionFactorFerresamanoConverter articleConvertionFactorConverter;

	private static final String COMPANY_NUMBER = "00010";
	private static double taxEmpty = -1;
	private String companyCode = "CFSA";
	private String module = "ARTICLES";

	StringUtil stringUtil = new StringUtil();

	private final Logger LOG = LoggerFactory.getLogger(ArticleCFSamanoRepository.class);
	...
	public double getTaxByDefault(String branchCode, String idOperation) {
		...
		double tax = 0;
		var f0006 = F0006Mapper.toFsamanoF0006(f0006Repository.findWarehouseByCodeAndCompanyNumber(COMPANY_NUMBER, branchCode));
		if (f0006 != null) {
