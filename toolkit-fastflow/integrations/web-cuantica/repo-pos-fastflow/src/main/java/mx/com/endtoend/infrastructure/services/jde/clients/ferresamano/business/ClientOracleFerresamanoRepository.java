package mx.com.endtoend.infrastructure.services.jde.clients.ferresamano.business;
...
import mx.com.endtoend.infrastructure.services.jde.clients.ferresamano.entities.F0002;
...
import mx.com.endtoend.infrastructure.services.jde.clients.ferresamano.entities.F0111;
...
import mx.com.endtoend.infrastructure.services.jde.clients.ferresamano.repository.F0002FSamanoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.ferresamano.repository.F0101FSamanoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.ferresamano.repository.F0101Z2FSamanoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.ferresamano.repository.F0111FSamanoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.ferresamano.repository.F0111Z1FSamanoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.ferresamano.repository.F01151FSamanoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.ferresamano.repository.F01151Z1FSamanoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.ferresamano.repository.F0115FSamanoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.ferresamano.repository.F0115Z1FSamanoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.ferresamano.repository.F0116FFSamanoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.ferresamano.repository.F03012FSamanoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.ferresamano.repository.F03012Z1FSamanoRepository;
...
/**
 * Implementación JDE Oracle para FERRESAMANO Company
...
public class ClientOracleFerresamanoRepository implements ClientOracleRepository {

	private static final String REFERENCE_SM = "SMARTB";

	private final Logger LOG = LoggerFactory.getLogger(ClientOracleFerresamanoRepository.class);

	@Autowired
	private F0101Z2FSamanoRepository f0101z2Repository;

	@Autowired
	private F0115Z1FSamanoRepository f0115z1Repository;

	@Autowired
	private F03012Z1FSamanoRepository f03012z1Repository;

	@Autowired
	private F0002FSamanoRepository f0002Repository;

	@Autowired
	private F0101FSamanoRepository f0101Repository;
	...
	@Autowired
	private F01151FSamanoRepository f01151Repository;

	@Autowired
	private F03012FSamanoRepository f03012Repository;

	@Autowired
	private F0111FSamanoRepository f0111Repository;

	@Autowired
	private F0111Z1FSamanoRepository f0111z1Repository;

	@Autowired
	private F01151Z1FSamanoRepository f01151z1Repository;
