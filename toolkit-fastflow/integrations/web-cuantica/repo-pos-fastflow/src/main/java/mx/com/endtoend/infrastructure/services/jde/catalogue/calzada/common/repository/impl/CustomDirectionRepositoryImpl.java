package mx.com.endtoend.infrastructure.services.jde.catalogue.calzada.common.repository.impl;
...
import mx.com.endtoend.infrastructure.services.jde.catalogue.calzada.common.entities.QF0117;
import mx.com.endtoend.infrastructure.services.jde.catalogue.calzada.common.entities.QF0118;
import mx.com.endtoend.infrastructure.services.jde.catalogue.calzada.common.repository.CustomDirectionRepository;

@Repository
@ConditionalOnProperty(name = "app.calzadaOracle.enabled", havingValue = "true", matchIfMissing = false)
public class CustomDirectionRepositoryImpl implements CustomDirectionRepository {

    private final Logger LOG = LoggerFactory.getLogger(CustomDirectionRepositoryImpl.class);
    @Autowired
    @Qualifier("calzadaOracleEntityManagerFactory")
    EntityManager em;

    public CustomDirectionRepositoryImpl(EntityManager entityManager) {
