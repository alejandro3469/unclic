...
import mx.com.endtoend.infrastructure.articles.ferresamano.customArticles.repositories.CustomArticleFSamanoRepository;
...
@Service
public class CustArticleCFSamanoRepository implements GenericCustomArticleRepository {

	@Autowired
	private CustomArticleConverter customArticleConverter;

	@Autowired
	private CustomArticleFSamanoRepository customArticleEntityRepository;

	private final Logger LOG = LoggerFactory.getLogger(CustArticleCFSamanoRepository.class);
