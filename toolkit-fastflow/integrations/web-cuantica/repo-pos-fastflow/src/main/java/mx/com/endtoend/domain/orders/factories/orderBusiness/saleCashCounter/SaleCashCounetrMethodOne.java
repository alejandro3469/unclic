...
public class SaleCashCounetrMethodOne implements OrderBusinessInterface {
	...
	public SaleCashCounetrMethodOne(CustomInterfaceOrderParams customInterfaceOrderParams) {
	...
	private final static Logger LOG = LoggerFactory.getLogger(SaleCashCounetrMethodOne.class);

	private ValidationToSaleCashCounter validationToSaleCashCounter = new ValidationToSaleCashCounter();
	...
	public OrderDto createOrder(OrderDto orderDto) {
		...
		String validations = validationToSaleCashCounter.validParamsMethodOne(orderPersistencePort, orderJdeServicePort,
