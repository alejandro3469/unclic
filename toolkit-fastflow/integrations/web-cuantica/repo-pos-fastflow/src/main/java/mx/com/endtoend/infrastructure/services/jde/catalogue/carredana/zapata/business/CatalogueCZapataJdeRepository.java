package mx.com.endtoend.infrastructure.services.jde.catalogue.carredana.zapata.business;
...
public class CatalogueCZapataJdeRepository implements GenericCatalogueJdeRepository {
	...
	private final Logger LOG = LoggerFactory.getLogger(CatalogueCZapataJdeRepository.class);
	...
	public ResponseModel getBrancgAddressByCode(String branchCode, String idOperation) {
		try {
			...
			F0006 f0006 = F0006Mapper.toZapataF0006(f0006Repository.findWarehouseByCodeAndCompanyNumber(COMPANY_NUMBER, branchCode.trim()));
			if (f0006 != null) {
