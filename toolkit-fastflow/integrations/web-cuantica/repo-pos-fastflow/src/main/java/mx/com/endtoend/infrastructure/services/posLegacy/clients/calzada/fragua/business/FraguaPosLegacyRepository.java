package mx.com.endtoend.infrastructure.services.posLegacy.clients.calzada.fragua.business;
...
import mx.com.endtoend.infrastructure.services.posLegacy.clients.calzada.fragua.repositories.ClientSqlCFraguaRepository;
import mx.com.endtoend.infrastructure.services.posLegacy.clients.calzada.fragua.repositories.ShippingAddressSqlCFraguaRepository;
...
@Service
public class FraguaPosLegacyRepository implements ClientLegacyRepository {

	@Autowired(required = false)
	private ClientSqlCFraguaRepository clientSqlRepository;

	@Autowired(required = false)
	private ShippingAddressSqlCFraguaRepository addressSqlRepository;

	@Autowired
	private ClientMailFraguaRepository clientMailRepository;

	@Autowired
	private ClientDirectionFraguaRepository clientDirectionRepository;

	@Autowired
	private ShippingAddressFraguaRepository shippingAddressRepository;

	private final Logger LOG = LoggerFactory.getLogger(FraguaPosLegacyRepository.class);
