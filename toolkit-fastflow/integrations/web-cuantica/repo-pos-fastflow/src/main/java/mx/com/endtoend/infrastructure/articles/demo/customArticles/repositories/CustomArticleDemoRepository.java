package mx.com.endtoend.infrastructure.articles.demo.customArticles.repositories;
...
@Repository
public interface CustomArticleDemoRepository extends JpaRepository<CustomArticleEntity, Long>{
