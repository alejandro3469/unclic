...
import mx.com.endtoend.infrastructure.articles.calzada.oracle.entities.F4106Id;

@Repository
public interface F4106Repository extends JpaRepository<F4106, F4106Id>{
	...
	Integer findUnitMeasurementByBpitmAndBPmcuAndJulianDate(@Param("itm") BigDecimal itm, @Param("mcu") String  mcu, @Param("date") BigDecimal  date);
}
