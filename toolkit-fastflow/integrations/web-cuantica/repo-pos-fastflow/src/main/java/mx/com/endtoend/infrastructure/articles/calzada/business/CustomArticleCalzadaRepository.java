...
import mx.com.endtoend.infrastructure.articles.calzada.repositories.CustomArticleEntityRepository;
...
@Service
public class CustomArticleCalzadaRepository implements GenericCustomArticleRepository {

	@Autowired
	private CustomArticleConverter customArticleConverter;

	@Autowired
	private CustomArticleEntityRepository customArticleEntityRepository;

	private final Logger LOG = LoggerFactory.getLogger(CustomArticleCalzadaRepository.class);
