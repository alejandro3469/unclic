package mx.com.endtoend.infrastructure.articles.ferresamano.customArticles.repositories;
...
@Repository
public interface CustomArticleFSamanoRepository extends JpaRepository<CustomArticleEntity, Long>{
