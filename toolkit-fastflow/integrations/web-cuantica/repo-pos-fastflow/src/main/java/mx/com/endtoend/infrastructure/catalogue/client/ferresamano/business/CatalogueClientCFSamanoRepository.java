package mx.com.endtoend.infrastructure.catalogue.client.ferresamano.business;
...
import mx.com.endtoend.infrastructure.catalogue.client.ferresamano.repositories.CFDIFSamanoRepository;
import mx.com.endtoend.infrastructure.catalogue.client.ferresamano.repositories.ClientTypeFSamanoRepository;
import mx.com.endtoend.infrastructure.catalogue.client.ferresamano.repositories.ContactMethodFSamanoRepository;
import mx.com.endtoend.infrastructure.catalogue.client.ferresamano.repositories.RegimeFiscalFSamanoRepository;
import mx.com.endtoend.infrastructure.catalogue.client.ferresamano.repositories.WorkTypeFSamanoRepository;
...
@Service
public class CatalogueClientCFSamanoRepository implements GenericCatalogueClientRepository {

	@Autowired
	private ClientTypeFSamanoRepository clientTypeRepository;

	@Autowired
	private ClientTypeConverter clientTypeConverter;

	@Autowired
	private WorkTypeFSamanoRepository workTypeRepository;

	@Autowired
	private WorkTypeConverter workTypeConverter;

	@Autowired
	private RegimeFiscalFSamanoRepository regimeFiscalRepository;

	@Autowired
	private RegimeFiscalConverter regimeFiscalConverter;

	@Autowired
	private CFDIFSamanoRepository cfdiRepository;

	@Autowired
	private CFDIConverter cfdiConverter;

	@Autowired
	private ContactMethodFSamanoRepository contactMethodRepository;

	@Autowired
	private ContactMethodConverter contactMethodConverter;

	private final Logger LOG = LoggerFactory.getLogger(CatalogueClientCFSamanoRepository.class);
