package mx.com.endtoend.infrastructure.articles.carredana.customArticles.business;
...
import mx.com.endtoend.infrastructure.articles.carredana.customArticles.repositories.CustomArticleFCarRepository;
...
@Service
public class CustArticleFCarRepository implements GenericCustomArticleRepository {

	@Autowired
	private CustomArticleConverter customArticleConverter;

	@Autowired
	private CustomArticleFCarRepository customArticleEntityRepository;

	private final Logger LOG = LoggerFactory.getLogger(CustArticleFCarRepository.class);
