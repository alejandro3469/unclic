package mx.com.endtoend.infrastructure.catalogue.client.carredana.zapata.business;
...
import mx.com.endtoend.infrastructure.catalogue.client.carredana.zapata.repositories.CFDICZapataRepository;
import mx.com.endtoend.infrastructure.catalogue.client.carredana.zapata.repositories.ClientTypeCZapataRepository;
import mx.com.endtoend.infrastructure.catalogue.client.carredana.zapata.repositories.ContactMethodCZapataRepository;
import mx.com.endtoend.infrastructure.catalogue.client.carredana.zapata.repositories.RegimeFiscalCZapataRepository;
import mx.com.endtoend.infrastructure.catalogue.client.carredana.zapata.repositories.WorkTypeCZapataRepository;
...
@Service
public class CatalogueClientCZapataRepository implements GenericCatalogueClientRepository {

	@Autowired
	private ClientTypeCZapataRepository clientTypeRepository;

	@Autowired
	private ClientTypeConverter clientTypeConverter;

	@Autowired
	private WorkTypeCZapataRepository workTypeRepository;

	@Autowired
	private WorkTypeConverter workTypeConverter;

	@Autowired
	private RegimeFiscalCZapataRepository regimeFiscalRepository;

	@Autowired
	private RegimeFiscalConverter regimeFiscalConverter;

	@Autowired
	private CFDICZapataRepository cfdiRepository;

	@Autowired
	private CFDIConverter cfdiConverter;

	@Autowired
	private ContactMethodCZapataRepository contactMethodRepository;

	@Autowired
	private ContactMethodConverter contactMethodConverter;

	private final Logger LOG = LoggerFactory.getLogger(CatalogueClientCZapataRepository.class);
