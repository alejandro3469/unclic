...
import mx.com.endtoend.infrastructure.articles.demo.oracle.entities.QF4101;
import mx.com.endtoend.infrastructure.articles.demo.oracle.entities.QF4102;
import mx.com.endtoend.infrastructure.articles.demo.oracle.entities.QF41021;
import mx.com.endtoend.infrastructure.articles.demo.oracle.entities.QF4106;
...
public class CustomDslArticleDemoRepositoryImpl extends QuerydslRepositorySupport {

	@Autowired
	@Qualifier("demoOracleEntityManagerFactory")
	EntityManager em;

	public CustomDslArticleDemoRepositoryImpl() {
