...
import mx.com.endtoend.infrastructure.articles.demo.oracle.converters.ArticleConvertionFactorDemoConverter;
...
import mx.com.endtoend.infrastructure.articles.demo.oracle.entities.F4102;
import mx.com.endtoend.infrastructure.articles.demo.oracle.entities.F4104;
import mx.com.endtoend.infrastructure.articles.demo.oracle.repositories.CustomDslArticleDemoRepositoryImpl;
import mx.com.endtoend.infrastructure.articles.demo.oracle.repositories.F4008DemoRepository;
...
import mx.com.endtoend.infrastructure.articles.demo.oracle.repositories.F4102DemoRepository;
import mx.com.endtoend.infrastructure.articles.demo.oracle.repositories.F4104DemoRepository;
import mx.com.endtoend.infrastructure.articles.demo.oracle.repositories.F4106DemoRepository;
...
@Service
public class ArticleDemoRepository implements GenericArticleRepository {

	@Autowired
	private DebugServicePort debugServicePort;

	@Autowired(required = false)
	private F4102DemoRepository f4102Repository;
	...
	@Autowired(required = false)
	private F4106DemoRepository f4106Repository;

	@Autowired(required = false)
	private F4008DemoRepository f4008Repository;

	@Autowired(required = false)
	private F4104DemoRepository f4104Repository;
	...
	@Autowired(required = false)
	private CustomDslArticleDemoRepositoryImpl customDslArticleRepositoryImpl;

	@Autowired(required = false)
	private ArticleConvertionFactorDemoConverter articleConvertionFactorConverter;

	private static double taxEmpty = -1;
	private String companyCode = "00001";
	private String module = "ARTICLES";
	StringUtil stringUtil = new StringUtil();

	private final Logger LOG = LoggerFactory.getLogger(ArticleDemoRepository.class);
	...
	public double getTaxByDefault(String branchCode, String idOperation) {
		...
		double tax = 0;
		//TODO: QIUTAR CODIGO DURO DE COMPAÑIA
		F0006 f0006 = F0006Mapper.toDemoF0006(f0006Repository.findWarehouseByCodeAndCompanyNumber("00001", branchCode));
		if (f0006 != null) {
