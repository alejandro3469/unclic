...
import mx.com.endtoend.infrastructure.articles.carredana.zapata.repositories.CustomArticleCZapataRepository;
...
@Service
public class CustArticleCZapataRepository implements GenericCustomArticleRepository {

	@Autowired
	private CustomArticleConverter customArticleConverter;

	@Autowired
	private CustomArticleCZapataRepository customArticleEntityRepository;

	private final Logger LOG = LoggerFactory.getLogger(CustArticleCZapataRepository.class);
