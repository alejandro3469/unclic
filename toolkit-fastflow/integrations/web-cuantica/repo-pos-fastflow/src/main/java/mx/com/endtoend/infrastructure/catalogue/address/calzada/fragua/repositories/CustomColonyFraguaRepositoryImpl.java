...
@Repository
public class CustomColonyFraguaRepositoryImpl implements CustomColonyFraguaRepository {

    private final Logger LOG = LoggerFactory.getLogger(CustomColonyFraguaRepositoryImpl.class);
    @Autowired
    @Qualifier("fraguaDataEntityManagerFactory")
    EntityManager em;

    public CustomColonyFraguaRepositoryImpl(EntityManager entityManager) {
