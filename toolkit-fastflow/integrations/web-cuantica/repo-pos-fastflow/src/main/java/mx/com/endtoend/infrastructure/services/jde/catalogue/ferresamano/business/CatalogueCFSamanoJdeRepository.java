package mx.com.endtoend.infrastructure.services.jde.catalogue.ferresamano.business;
...
import mx.com.endtoend.infrastructure.services.jde.catalogue.ferresamano.common.converters.CatalogueAddressFFerresamanoConverter;
import mx.com.endtoend.infrastructure.services.jde.catalogue.ferresamano.common.converters.CatalogueArticleFFerresamanoConverter;
import mx.com.endtoend.infrastructure.services.jde.catalogue.ferresamano.common.converters.CatalogueClientFFerresamanoConverter;
import mx.com.endtoend.infrastructure.services.jde.catalogue.ferresamano.common.converters.F0005FFerresamanoConverter;
import mx.com.endtoend.infrastructure.services.jde.catalogue.ferresamano.common.converters.F0005JdeFFerresamanoConverter;
import mx.com.endtoend.infrastructure.services.jde.catalogue.ferresamano.common.converters.F0117FFerresamanoConverter;
...
import mx.com.endtoend.infrastructure.services.jde.catalogue.ferresamano.common.repository.F0117FFerresamanoRepository;
import mx.com.endtoend.infrastructure.services.jde.catalogue.ferresamano.common.repository.impl.CustomDirectionFFerresamanoRepositoryImpl;
import mx.com.endtoend.infrastructure.services.jde.clients.ferresamano.entities.F0115;
import mx.com.endtoend.infrastructure.services.jde.clients.ferresamano.entities.F0116;
import mx.com.endtoend.infrastructure.services.jde.clients.ferresamano.repository.F0115FSamanoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.ferresamano.repository.F0116FFSamanoRepository;
import mx.com.endtoend.infrastructure.warehouse.ferresamano.entities.F0006;
...
public class CatalogueCFSamanoJdeRepository implements GenericCatalogueJdeRepository {

	@Autowired
	private CatalogueRepository catalogueRepository;

	@Autowired
	private F0005FFerresamanoConverter f0005Converter;

	@Autowired
	private F0005JdeFFerresamanoConverter f0005JdeConverter;

	@Autowired
	private F0005FFerresamanoRepository f0005Repository;

	@Autowired
	private F0006FsamaoRepository f0006Repository;

	@Autowired
	private F0116FFSamanoRepository f0116Repository;

	@Autowired
	private F0115FSamanoRepository f0115Repository;

	@Autowired
	private F0117FFerresamanoRepository f0117Repository;

	@Autowired
	private F0117FFerresamanoConverter f0117Converter;

	@Autowired
	private CatalogueClientFFerresamanoConverter catalogueClientConverter;

	@Autowired
	private CatalogueArticleFFerresamanoConverter catalogueArticleConverter;

	@Autowired
	private CatalogueAddressFFerresamanoConverter catalogueAddressConverter;

	@Autowired
	private CustomDirectionFFerresamanoRepositoryImpl customDirectionRepository;

	private static final String COMPANY_NUMBER = "00010";

	private final Logger LOG = LoggerFactory.getLogger(CatalogueCFSamanoJdeRepository.class);
	...
	public ResponseModel getBrancgAddressByCode(String branchCode, String idOperation) {
		try {
			...
			F0006 f0006 = F0006Mapper.toFsamanoF0006(f0006Repository.findWarehouseByCodeAndCompanyNumber(COMPANY_NUMBER, branchCode.trim()));
			if (f0006 != null) {
				Long an8 = f0006.getMcan8().longValue();
				F0116 f0116 = f0116Repository.findByAn8(an8);
				if (f0116 != null) {

					branchAddressDto = new BranchAddressDto();

					branchAddressDto.setStreet(f0116.getStreet());
					branchAddressDto.setColony(f0116.getColony());
					branchAddressDto.setCp(f0116.getCp());

					String insideNumber = "";
					String outsideNumber = f0116.getNoOuNoIn();
					String fullNumber = f0116.getNoOuNoIn();
					...
					String phoneNumber = "";
					F0115 f0115 = f0115Repository.findByAn8(an8);
					if (f0115 != null) {
