package mx.com.endtoend.infrastructure.services.jde.orders.carredana.zapata.business;
...
public class OrderCZapataJdeRepository implements GenericOrderJdeRepository {
	...
	private final Logger LOG = LoggerFactory.getLogger(OrderCZapataJdeRepository.class);
	...
	private String companyKey = "00006";
