...
public class SummarySaleTransferPaymentDto {
	...
	public SummarySaleTransferPaymentDto(Long paymentId, Date paymentDate, BigDecimal orderNumber, String orderCode,
			...
			BigDecimal amountApplied, String bankingInstitution, String referenceNumber, String trackingNumber) {
		super();
