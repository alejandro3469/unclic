...
import mx.com.endtoend.infrastructure.services.jde.clients.demo.entities.QF0101;
import mx.com.endtoend.infrastructure.services.jde.clients.demo.repository.CustomF0101DemoRepository;

@Repository
@ConditionalOnProperty(name = "app.demo.oracle.enabled", havingValue = "true", matchIfMissing = false)
public class CustomF0101DemoRepositoryImpl implements CustomF0101DemoRepository {

	private final Logger LOG = LoggerFactory.getLogger(CustomF0101DemoRepositoryImpl.class);
