package mx.com.endtoend.infrastructure.services.jde.catalogue.ferresamano.common.repository.impl;
...
import mx.com.endtoend.infrastructure.services.jde.catalogue.ferresamano.common.entities.QF0117;
import mx.com.endtoend.infrastructure.services.jde.catalogue.ferresamano.common.entities.QF0118;
import mx.com.endtoend.infrastructure.services.jde.catalogue.ferresamano.common.repository.CustomDirectionFFerresamanoRepository;

@Repository
@ConditionalOnProperty(name = "app.ferresamano.oracle.enabled", havingValue = "true", matchIfMissing = false)
public class CustomDirectionFFerresamanoRepositoryImpl implements CustomDirectionFFerresamanoRepository {

    private final Logger LOG = LoggerFactory.getLogger(CustomDirectionFFerresamanoRepositoryImpl.class);
    @Autowired
    @Qualifier("ferresamanoOracleEntityManagerFactory")
    EntityManager em;

    public CustomDirectionFFerresamanoRepositoryImpl(EntityManager entityManager) {
