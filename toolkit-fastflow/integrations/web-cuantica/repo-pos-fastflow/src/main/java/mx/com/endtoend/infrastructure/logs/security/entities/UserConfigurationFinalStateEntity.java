...
@Entity
@Table(name = "user_config_final_states")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
public class UserConfigurationFinalStateEntity {
	...
	@Column(name = "employee_final_id", nullable = false)
	private Long employeeFinalId;
