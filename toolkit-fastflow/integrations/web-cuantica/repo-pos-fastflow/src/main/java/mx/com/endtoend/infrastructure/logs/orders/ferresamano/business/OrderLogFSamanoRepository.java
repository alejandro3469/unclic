package mx.com.endtoend.infrastructure.logs.orders.ferresamano.business;
...
import mx.com.endtoend.infrastructure.logs.orders.ferresamano.repositories.OrderDetailFinalStateLogFSamRepository;
import mx.com.endtoend.infrastructure.logs.orders.ferresamano.repositories.OrderDetailPrevStateLogFSamRepository;
import mx.com.endtoend.infrastructure.logs.orders.ferresamano.repositories.OrderFinalStateLogFSamRepository;
import mx.com.endtoend.infrastructure.logs.orders.ferresamano.repositories.OrderLogFSamRepository;
import mx.com.endtoend.infrastructure.logs.orders.ferresamano.repositories.OrderPrevStateLogFSamRepository;
...
@Service
public class OrderLogFSamanoRepository implements GenericOrderLogPersistenceInterface {

	@Autowired
	private OrderLogConverter orderLogConverter;

	@Autowired
	private OrderLogFSamRepository orderLogFCalRepository;

	@Autowired
	private OrderDetailFinalStateLogFSamRepository orderDetailFinalStateLogFCalRepository;

	@Autowired
	private OrderDetailPrevStateLogFSamRepository orderDetailPrevStateLogFCalRepository;

	@Autowired
	private OrderFinalStateLogFSamRepository orderFinalStateLogFCalRepository;

	@Autowired
	private OrderPrevStateLogFSamRepository orderPrevStateLogFCalRepository;

	private final Logger LOG = LoggerFactory.getLogger(OrderLogFSamanoRepository.class);
