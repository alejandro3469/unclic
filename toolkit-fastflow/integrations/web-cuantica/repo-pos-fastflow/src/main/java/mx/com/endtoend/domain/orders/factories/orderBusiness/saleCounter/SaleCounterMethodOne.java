...
public class SaleCounterMethodOne implements OrderBusinessInterface {
	...
	public SaleCounterMethodOne(CustomInterfaceOrderParams customInterfaceOrderParams) {
	...
	private final static Logger LOG = LoggerFactory.getLogger(SaleCounterMethodOne.class);

	private ValidationToSaleCounterOrder validationToSaleCounterOrder = new ValidationToSaleCounterOrder();
	...
	public OrderDto createOrder(OrderDto orderDto) {
		...
		String validations = validationToSaleCounterOrder.validParamsMethodOne(orderPersistencePort,
				orderJdeServicePort, orderConfigurationDto, orderDto, idOperation, companyCode, branchCode);
