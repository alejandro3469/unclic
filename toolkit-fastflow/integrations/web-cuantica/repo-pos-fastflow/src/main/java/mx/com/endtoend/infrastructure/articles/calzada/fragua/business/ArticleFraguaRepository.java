...
@Service
public class ArticleFraguaRepository implements GenericArticleRepository {
	...
	private String companyCode = "CFRA";
	private String module = "ARTICLES";

	StringUtil stringUtil = new StringUtil();

	private final Logger LOG = LoggerFactory.getLogger(ArticleFraguaRepository.class);
	...
	public List<ArticleDto> findArticlesByParams(GenericSerchParamsArticleDto params, String branchCode,
		...
		try {
			...
			debugServicePort.saveLog(module, companyCode, "I-PARAMS: [ " + params.toString() + " ]", idOperation,
					debug);
	...
	public double getTaxByDefault(String branchCode, String idOperation) {
		...
		F0006 f0006 = F0006Mapper.toCalzadaF0006(f0006Repository.findWarehouseByCodeAndCompanyNumber(COMPANY_NUMBER, branchCode));
		if (f0006 != null) {
