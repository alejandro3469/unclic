...
import mx.com.endtoend.infrastructure.articles.ferresamano.oracle.entities.QF4101;
import mx.com.endtoend.infrastructure.articles.ferresamano.oracle.entities.QF4102;
import mx.com.endtoend.infrastructure.articles.ferresamano.oracle.entities.QF41021;
import mx.com.endtoend.infrastructure.articles.ferresamano.oracle.entities.QF4106;
...
public class CustomDslArticleFerresamanoRepositoryImpl extends QuerydslRepositorySupport {

	@Autowired
	@Qualifier("ferresamanoOracleEntityManagerFactory")
	EntityManager em;

	public CustomDslArticleFerresamanoRepositoryImpl() {
		super(ArticleDto.class);
	}

	private final Logger LOG = LoggerFactory.getLogger(CustomDslArticleFerresamanoRepositoryImpl.class);
	...
	public List<ArticleDto> findArticlesByParams(GenericSerchParamsArticleDto serrchParams) {
		...
		QF4106 F4106Sub = new QF4106("F4106Sub");
		...
		LOG.info("FIND BY CATALOGO- QUERY: "+ sql);
		/**
