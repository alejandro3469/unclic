...
@Entity
@Table(name = "order_detail_final_state_log")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
public class OrderDetailFinalStateEntity {
	...
	@Column(name = "order_final_state_id", nullable = false)
	private Long orderFinalStateId;
