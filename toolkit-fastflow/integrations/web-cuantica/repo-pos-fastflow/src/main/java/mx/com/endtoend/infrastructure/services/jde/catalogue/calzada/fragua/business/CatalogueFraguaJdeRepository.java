package mx.com.endtoend.infrastructure.services.jde.catalogue.calzada.fragua.business;
...
import mx.com.endtoend.infrastructure.warehouse.calzada.fragua.entities.F0006;
...
import mx.com.endtoend.infrastructure.services.jde.catalogue.calzada.common.converters.CatalogueAddressConverter;
import mx.com.endtoend.infrastructure.services.jde.catalogue.calzada.common.converters.CatalogueArticleConverter;
import mx.com.endtoend.infrastructure.services.jde.catalogue.calzada.common.converters.CatalogueClientConverter;
import mx.com.endtoend.infrastructure.services.jde.catalogue.calzada.common.converters.F0005Converter;
import mx.com.endtoend.infrastructure.services.jde.catalogue.calzada.common.converters.F0005JdeConverter;
import mx.com.endtoend.infrastructure.services.jde.catalogue.calzada.common.converters.F0117Converter;
...
import mx.com.endtoend.infrastructure.services.jde.catalogue.calzada.common.repository.F0117Repository;
import mx.com.endtoend.infrastructure.services.jde.catalogue.calzada.common.repository.impl.CustomDirectionRepositoryImpl;
import mx.com.endtoend.infrastructure.services.jde.clients.calzada.entities.F0115;
import mx.com.endtoend.infrastructure.services.jde.clients.calzada.entities.F0116;
import mx.com.endtoend.infrastructure.services.jde.clients.calzada.repository.F0115Repository;
import mx.com.endtoend.infrastructure.services.jde.clients.calzada.repository.F0116Repository;
...
public class CatalogueFraguaJdeRepository implements GenericCatalogueJdeRepository {

	private static final String COMPANY_NUMBER = "00009";

	@Autowired
	private CatalogueRepository catalogueRepository;

	@Autowired
	private F0005Converter f0005Converter;

	@Autowired
	private F0005JdeConverter f0005JdeConverter;

	@Autowired
	private F0005Repository f0005Repository;

	@Autowired
	private F0006FraguaRepository f0006Repository;

	@Autowired
	private F0116Repository f0116Repository;

	@Autowired
	private F0115Repository f0115Repository;

	@Autowired
	private F0117Repository f0117Repository;

	@Autowired
	private F0117Converter f0117Converter;

	@Autowired
	private CatalogueClientConverter catalogueClientConverter;

	@Autowired
	private CatalogueArticleConverter catalogueArticleConverter;

	@Autowired
	private CatalogueAddressConverter catalogueAddressConverter;

	@Autowired
	private CustomDirectionRepositoryImpl customDirectionRepository;

	private final Logger LOG = LoggerFactory.getLogger(CatalogueFraguaJdeRepository.class);
	...
	public ResponseModel getBrancgAddressByCode(String branchCode, String idOperation) {
		try {
			...
			F0006 f0006 = F0006Mapper.toFraguaF0006(f0006Repository.findWarehouseByCodeAndCompanyNumber(COMPANY_NUMBER, branchCode.trim()));
			if (f0006 != null) {
	...
	public ResponseModel getClientType(String idOperation) {
		try {
			...
			List<F0005> f0005List = f0005Repository.findByDrsyAndDrrtAndDrsphd("01", "06", "1");
			if (f0005List.size() != 0) {
				LOG.info(String.format("%s INIT CONVERTION", idOperation));
	...
	public ResponseModel getHowToContactByCompanyCode(String idOperation) {
		try {
			...
			List<F0005> f0005List = f0005Repository.findByDrsyAndDrrtAndDrsphd("01", "16", "1");
			if (f0005List.size() != 0) {
				LOG.info(String.format("%s INIT CONVERTION", idOperation));
	...
	public ResponseModel getArticleBrand(String idOperation) {
		try {
			...
			List<F0005> f0005List = f0005Repository.findByDrsyAndDrrtAndDrsphd("41", "S5", "1");
			if (f0005List.size() != 0) {
				LOG.info(String.format("%s INIT CONVERTION", idOperation));
	...
	public ResponseModel getArticleCategory(String idOperation) {
		try {
			...
			List<F0005> f0005List = f0005Repository.findByDrsyAndDrrtAndDrsphd("41", "S2", "1");
			if (f0005List.size() != 0) {
				LOG.info(String.format("%s INIT CONVERTION", idOperation));
	...
	public ResponseModel getArticleFamily(String idOperation) {
		try {
			...
			List<F0005> f0005List = f0005Repository.findByDrsyAndDrrtAndDrsphd("41", "S3", "1");
			if (f0005List.size() != 0) {
				LOG.info(String.format("%s INIT CONVERTION", idOperation));
	...
	public ResponseModel getArticleDivision(String idOperation) {
		try {
			...
			List<F0005> f0005List = f0005Repository.findByDrsyAndDrrtAndDrsphd("41", "S1", "1");
			if (f0005List.size() != 0) {
				LOG.info(String.format("%s INIT CONVERTION", idOperation));
