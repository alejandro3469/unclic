package mx.com.endtoend.infrastructure.services.jde.catalogue.demo.business;
...
import mx.com.endtoend.infrastructure.services.jde.catalogue.demo.common.converters.CatalogueAddressFDemoConverter;
import mx.com.endtoend.infrastructure.services.jde.catalogue.demo.common.converters.CatalogueArticleFDemoConverter;
import mx.com.endtoend.infrastructure.services.jde.catalogue.demo.common.converters.CatalogueClientFDemoConverter;
import mx.com.endtoend.infrastructure.services.jde.catalogue.demo.common.converters.F0005FDemoConverter;
import mx.com.endtoend.infrastructure.services.jde.catalogue.demo.common.converters.F0005JdeFDemoConverter;
import mx.com.endtoend.infrastructure.services.jde.catalogue.demo.common.converters.F0117FDemoConverter;
import mx.com.endtoend.infrastructure.services.jde.catalogue.demo.common.entities.F0005;
import mx.com.endtoend.infrastructure.services.jde.catalogue.demo.common.entities.F0117;
import mx.com.endtoend.infrastructure.services.jde.catalogue.demo.common.repository.F0005FDemoRepository;
import mx.com.endtoend.infrastructure.services.jde.catalogue.demo.common.repository.F0117FDemoRepository;
import mx.com.endtoend.infrastructure.services.jde.catalogue.demo.common.repository.impl.CustomDirectionFDemoRepositoryImpl;
...
import mx.com.endtoend.infrastructure.services.jde.clients.demo.repository.F0115FDemoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.demo.repository.F0116FDemoRepository;
import mx.com.endtoend.infrastructure.warehouse.demo.entities.F0006;
...
public class CatalogueFDemoJdeRepository implements GenericCatalogueJdeRepository {

	private static final String COMPANY_NUMBER = "00001";

	@Autowired
	private CatalogueRepository catalogueRepository;

	@Autowired
	private F0005FDemoConverter f0005Converter;

	@Autowired
	private F0005JdeFDemoConverter f0005JdeConverter;
	...
	@Autowired
	private F0115FDemoRepository f0115Repository;

	@Autowired
	private F0117FDemoRepository f0117Repository;

	@Autowired
	private F0117FDemoConverter f0117Converter;

	@Autowired
	private CatalogueClientFDemoConverter catalogueClientConverter;

	@Autowired
	private CatalogueArticleFDemoConverter catalogueArticleConverter;

	@Autowired
	private CatalogueAddressFDemoConverter catalogueAddressConverter;

	@Autowired
	private CustomDirectionFDemoRepositoryImpl customDirectionRepository;

	private final Logger LOG = LoggerFactory.getLogger(CatalogueFDemoJdeRepository.class);
	...
	public ResponseModel getBrancgAddressByCode(String branchCode, String idOperation) {
		try {
			...
			F0006 f0006 = F0006Mapper.toDemoF0006(f0006Repository.findWarehouseByCodeAndCompanyNumber(COMPANY_NUMBER, branchCode.trim()));
			if (f0006 != null) {
