package mx.com.endtoend.infrastructure.services.jde.clients.demo.business;
...
import mx.com.endtoend.infrastructure.services.jde.clients.demo.entities.F0002;
...
import mx.com.endtoend.infrastructure.services.jde.clients.demo.entities.F0101Z2Id;
import mx.com.endtoend.infrastructure.services.jde.clients.demo.entities.F0111;
import mx.com.endtoend.infrastructure.services.jde.clients.demo.entities.F0111Z1;
import mx.com.endtoend.infrastructure.services.jde.clients.demo.entities.F0111Z1Id;
import mx.com.endtoend.infrastructure.services.jde.clients.demo.entities.F0115;
...
import mx.com.endtoend.infrastructure.services.jde.clients.demo.entities.F0115Z1;
import mx.com.endtoend.infrastructure.services.jde.clients.demo.entities.F0115Z1Id;
...
import mx.com.endtoend.infrastructure.services.jde.clients.demo.repository.F0002DemoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.demo.repository.F0101DemoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.demo.repository.F0101Z2DemoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.demo.repository.F0111DemoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.demo.repository.F0111Z1DemoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.demo.repository.F01151DemoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.demo.repository.F01151Z1DemoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.demo.repository.F0115DemoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.demo.repository.F0115Z1DemoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.demo.repository.F0116FDemoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.demo.repository.F03012DemoRepository;
import mx.com.endtoend.infrastructure.services.jde.clients.demo.repository.F03012Z1DemoRepository;
...
/**
 * Implementación JDE Oracle para DEMO Company
 * Basado en la estructura de Calzada y Carredana
 * 
 * @author Sistema
 *
 */
...
public class ClientOracleDemoRepository implements ClientOracleRepository {

	private static final String REFERENCE_SM = "SMARTB";

	private final Logger LOG = LoggerFactory.getLogger(ClientOracleDemoRepository.class);

	@Autowired
	private F0101Z2DemoRepository f0101z2Repository;

	@Autowired
	private F0115Z1DemoRepository f0115z1Repository;

	@Autowired
	private F03012Z1DemoRepository f03012z1Repository;

	@Autowired
	private F0002DemoRepository f0002Repository;

	@Autowired
	private F0101DemoRepository f0101Repository;

	@Autowired
	private F0116FDemoRepository f0116Repository;

	@Autowired
	private F0115DemoRepository f0115Repository;

	@Autowired
	private F01151DemoRepository f01151Repository;

	@Autowired
	private F03012DemoRepository f03012Repository;

	@Autowired
	private F0111DemoRepository f0111Repository;

	@Autowired
	private F0111Z1DemoRepository f0111z1Repository;

	@Autowired
	private F01151Z1DemoRepository f01151z1Repository;

	@Autowired
	private F0005FDemoRepository f0005Repository;
