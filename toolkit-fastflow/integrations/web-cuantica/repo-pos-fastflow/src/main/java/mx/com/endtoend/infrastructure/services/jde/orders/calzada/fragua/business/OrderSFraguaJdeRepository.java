package mx.com.endtoend.infrastructure.services.jde.orders.calzada.fragua.business;
...
/**
 * Implementación concreta de la interfaz GenericOrderJdeRepository para la
 * compañía Fragua.
 * 
 * @author ddcasas
 *
...
public class OrderSFraguaJdeRepository implements GenericOrderJdeRepository {
	...
	private final Logger LOG = LoggerFactory.getLogger(OrderSFraguaJdeRepository.class);
