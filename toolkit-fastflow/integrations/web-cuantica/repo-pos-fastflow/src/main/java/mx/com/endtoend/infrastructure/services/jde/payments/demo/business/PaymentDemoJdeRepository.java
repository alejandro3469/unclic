package mx.com.endtoend.infrastructure.services.jde.payments.demo.business;
...
import mx.com.endtoend.infrastructure.services.jde.payments.demo.common.converters.OrderDemoJedConverter;
...
import mx.com.endtoend.infrastructure.services.jde.payments.demo.common.repository.F42119DemoRepository;
import mx.com.endtoend.infrastructure.services.jde.payments.demo.common.repository.F4211DemoRepository;
import mx.com.endtoend.infrastructure.services.jde.payments.demo.common.repository.F47011DemoRepository;
import mx.com.endtoend.infrastructure.services.jde.payments.demo.common.repository.F47012DemoRepository;
import mx.com.endtoend.infrastructure.services.jde.payments.demo.common.repository.F4706DemoRepository;
import mx.com.endtoend.infrastructure.services.jde.payments.demo.common.repository.F4714DemoRepository;
...
public class PaymentDemoJdeRepository implements GenericPaymentJdeRepository {

	@Autowired
	private OrderDemoJedConverter orderJDEConverter;
	...
	@Autowired
	private F47011DemoRepository f47011Repository;

	@Autowired
	private F47012DemoRepository f47012Repository;

	@Autowired
	private F4706DemoRepository f4706Repository;

	@Autowired
	private F4714DemoRepository f4714Repository;

	@Autowired
	private F41021DemoRepository f41021Repository;

	@Autowired
	private F4211DemoRepository f4211Repository;

	@Autowired
	private F42119DemoRepository f42119Repository;
	...
	@Value("${app.demo.jde.batchFolio.generator.url}")
	String urlbatchFolio;

	@Value("${app.demo.jde.consecutive.generator.url}")
	String urlNextOrderNumber;
	
	@Value("${app.demo.jde.company.code}")
	String companyCode;

	@Value("${app.demo.queue.jde.order.name}")
	private String queueCreateOrder;

	@Value("${app.demo.queue.jde.credit.note.name}")
	private String queueCreateCreditNote;

	@Value("${app.demo.queue.jde.invoice.name}")
	...
	public boolean saveOrder(OrderDto orderDto, String idOperation) {
		...
		try {
			...
			BigDecimal genericClientNumber = orderDemoJdeRepository.getGenericClientNumberByWarehouseCode(
