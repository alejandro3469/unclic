...
@Service
public class ArticleFCarredanaRepository implements GenericArticleRepository {
	...
	private String companyCode = "FCAR";
	private String module = "ARTICLES";

	StringUtil stringUtil = new StringUtil();

	private final Logger LOG = LoggerFactory.getLogger(ArticleFCarredanaRepository.class);
	...
	public double getTaxByDefault(String branchCode, String idOperation) {
		...
		F0006 f0006 = F0006Mapper.toCarredanaF0006(f0006Repository.findWarehouseByCodeAndCompanyNumber("00003", branchCode));
		if (f0006 != null) {
