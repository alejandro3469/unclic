package mx.com.endtoend.infrastructure.services.jde.catalogue.calzada.business;
...
import mx.com.endtoend.infrastructure.warehouse.calzada.entities.F0006;
...
public class CatalogueCalzadaJdeRepository implements GenericCatalogueJdeRepository {
	...
	private final Logger LOG = LoggerFactory.getLogger(CatalogueCalzadaJdeRepository.class);
	...
	public ResponseModel getBrancgAddressByCode(String branchCode, String idOperation) {
		try {
			...
			F0006 f0006 = F0006Mapper.toCalzadaF0006(f0006Repository.findWarehouseByCodeAndCompanyNumber(COMPANY_NUMBER, branchCode.trim()));
			if (f0006 != null) {
