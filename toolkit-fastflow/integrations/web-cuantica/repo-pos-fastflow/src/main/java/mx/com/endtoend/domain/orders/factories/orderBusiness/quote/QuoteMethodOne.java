...
public class QuoteMethodOne implements OrderBusinessInterface {
	...
	public QuoteMethodOne(CustomInterfaceOrderParams customInterfaceOrderParams) {
	...
	private final static Logger LOG = LoggerFactory.getLogger(QuoteMethodOne.class);

	private ValidationToQuoteOrder validationToQuoteOrder = new ValidationToQuoteOrder();
	...
	public OrderDto createOrder(OrderDto orderDto) {
		...
		String statusCode = StatusOrder.CREATE_QUOTE_ORDER.getValue();
		...
		String validations = validationToQuoteOrder.validParamsMethodOne(orderDto, orderConfigurationDto, idOperation);
	...
	public OrderDto updateOrder(OrderDto orderDto, OrderDto orderSaved) {
		...
		if (orderSaved.getIsConverted()) {
			...
			throw new ValidationError("YOU CANNOT EDIT A QUOTATION CONVERTED TO AN ORDER");
		}
