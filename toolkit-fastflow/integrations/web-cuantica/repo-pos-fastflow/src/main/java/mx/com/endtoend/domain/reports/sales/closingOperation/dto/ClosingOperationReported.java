...
public class ClosingOperationReported {
	...
	public ClosingOperationReported(Long transactionId, BigDecimal amountReported, String movementType) {
		super();
	...
	public ClosingOperationReported(BigDecimal amountReported, String movementType) {
		super();
		this.amountReported = DecimalPrecisionUtils.roundToTwoDecimals(amountReported);
		this.movementType = movementType;
	}
	...
	public String toString() {
		return "ClosingOperationReported [transactionId=" + transactionId + ", amountReported=" + amountReported
