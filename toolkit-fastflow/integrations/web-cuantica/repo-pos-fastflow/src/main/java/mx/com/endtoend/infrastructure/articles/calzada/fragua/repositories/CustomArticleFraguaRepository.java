package mx.com.endtoend.infrastructure.articles.calzada.fragua.repositories;
...
@Repository
public interface CustomArticleFraguaRepository extends JpaRepository<CustomArticleEntity, Long>{
