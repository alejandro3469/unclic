package mx.com.endtoend.infrastructure.articles.carredana.zapata.repositories;
...
@Repository
public interface CustomArticleCZapataRepository extends JpaRepository<CustomArticleEntity, Long>{
