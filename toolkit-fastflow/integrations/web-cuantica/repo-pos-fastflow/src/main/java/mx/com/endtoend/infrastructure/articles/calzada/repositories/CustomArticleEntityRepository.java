package mx.com.endtoend.infrastructure.articles.calzada.repositories;
...
@Repository
public interface CustomArticleEntityRepository extends JpaRepository<CustomArticleEntity, Long>{
