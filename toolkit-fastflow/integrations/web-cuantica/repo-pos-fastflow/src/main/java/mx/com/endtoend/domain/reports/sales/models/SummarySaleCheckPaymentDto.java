...
public class SummarySaleCheckPaymentDto {
	...
	public SummarySaleCheckPaymentDto(Long paymentId, Date paymentDate, BigDecimal orderNumber, String orderCode,
			...
			BigDecimal amountApplied, String bankingInstitution, String checkNumber) {
		super();
