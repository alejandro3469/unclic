package mx.com.endtoend.infrastructure.catalogue.client.calzada.fragua.business;
...
import mx.com.endtoend.infrastructure.catalogue.client.calzada.fragua.repositories.CFDIFraguaRepository;
import mx.com.endtoend.infrastructure.catalogue.client.calzada.fragua.repositories.ClientTypeFraguaRepository;
import mx.com.endtoend.infrastructure.catalogue.client.calzada.fragua.repositories.ContactMethodFraguaRepository;
import mx.com.endtoend.infrastructure.catalogue.client.calzada.fragua.repositories.RegimeFiscalFraguaRepository;
import mx.com.endtoend.infrastructure.catalogue.client.calzada.fragua.repositories.WorkTypeFraguaRepository;
...
@Service
public class CatalogueClientFraguaRepository implements GenericCatalogueClientRepository {

	@Autowired
	private ClientTypeFraguaRepository clientTypeRepository;

	@Autowired
	private ClientTypeConverter clientTypeConverter;

	@Autowired
	private WorkTypeFraguaRepository workTypeRepository;

	@Autowired
	private WorkTypeConverter workTypeConverter;

	@Autowired
	private RegimeFiscalFraguaRepository regimeFiscalRepository;

	@Autowired
	private RegimeFiscalConverter regimeFiscalConverter;

	@Autowired
	private CFDIFraguaRepository cfdiRepository;

	@Autowired
	private CFDIConverter cfdiConverter;

	@Autowired
	private ContactMethodFraguaRepository contactMethodRepository;

	@Autowired
	private ContactMethodConverter contactMethodConverter;

	private final Logger LOG = LoggerFactory.getLogger(CatalogueClientFraguaRepository.class);
