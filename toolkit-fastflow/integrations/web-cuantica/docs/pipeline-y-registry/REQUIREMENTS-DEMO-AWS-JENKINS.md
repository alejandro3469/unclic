...
| **Montar en local** | ✅ | docs/instalacion/, docs/pos-online/ (pasos y guías). Maven, opcional Jenkins, registry local, dashboard. |
...
| **Docker (imagen)** | ✅ | Dockerfile en raíz de pos-online; build según docs/pipeline-y-registry/BUILD-REGISTRY-FASTFLOW.md. |
...
1. **Local con capturas:** Seguir la guía local en **docs/instalacion/** y **docs/pos-online/**: Maven, Jenkins (opcional), registry local, dashboard. Guardar capturas en **docs/capturas/** si aplica (ver docs/capturas/README.md).
...
- **Presentación en vivo:** orden Registry → Jenkins → K8s → Terraform; puntos a mostrar en docs/pos-online y docs/pipeline-y-registry.
