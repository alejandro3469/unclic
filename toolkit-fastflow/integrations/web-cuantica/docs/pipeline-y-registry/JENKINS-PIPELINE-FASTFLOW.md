...
- **Build y registry (manual):** docs/pipeline-y-registry/BUILD-REGISTRY-FASTFLOW.md
- **Requerimientos demo AWS:** docs/pipeline-y-registry/REQUIREMENTS-DEMO-AWS-JENKINS.md
