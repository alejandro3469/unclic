...
|------------|-------------------------|
| **Jenkins** | Instalación open source (war o paquete). En este repo (toolkit): `docs/30-instalacion/INSTALAR-JENKINS.md`; en pos-online: `docs/INSTALAR-JENKINS.md`. |
...
| Build y registry (docs) | **docs/40-pipeline-registry/BUILD-REGISTRY-FASTFLOW.md**, **docs/40-pipeline-registry/JENKINS-PIPELINE-FASTFLOW.md** | Referencia para tags, push, variables y credenciales. |
| Guía local Jenkins + Docker + Registry | **docs/30-instalacion/GUIA-PASO-A-PASO-LOCAL-Y-EMPAQUETAR.md** (o toolkit-fastflow/docs) | Pasos para Java, Jenkins, Docker, registry local; adaptar a pos-online. |
...
- **Registry y build:** [../40-pipeline-registry/BUILD-REGISTRY-FASTFLOW.md](../40-pipeline-registry/BUILD-REGISTRY-FASTFLOW.md)
- **Pipeline Jenkins:** [../40-pipeline-registry/JENKINS-PIPELINE-FASTFLOW.md](../40-pipeline-registry/JENKINS-PIPELINE-FASTFLOW.md), Jenkinsfile.example (raíz)
