...
| **Registry** | Imagen con tag (ej. pos-online:latest o pos-online:main-123) | **http://localhost:5000/v2/_catalog** (JSON); **http://localhost:5000/v2/../60-pos-online/tags/list** (tags) |
...
| Ver registry | Navegador | JSON con repos e imágenes | **http://localhost:5000/v2/_catalog**; **http://localhost:5000/v2/../60-pos-online/tags/list** |
...
- **Directorio:** Raíz del repo pos-online (`/ruta/ejemplo/pos-online` o equivalente).
...
| Qué | Dónde |
|-----|--------|
| JAR instalado | `target/pos-online-0.0.1-SNAPSHOT.jar` y copia en `~/.m2/repository/mx/com/endtoend/../60-pos-online/0.0.1-SNAPSHOT/`. |
...
Esta guía se puede copiar a pos-online como `docs/GUIA-FLUJO-FINAL.md` (o mantener en docs/60-pos-online dentro del toolkit). Ajusta puertos y rutas según el entorno real (Linux, otro host, etc.).
