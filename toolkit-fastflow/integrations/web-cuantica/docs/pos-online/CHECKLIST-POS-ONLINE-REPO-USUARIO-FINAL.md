...
| `docs/pos-online/FLUJO-COMMIT-Y-USUARIO-FINAL.md` | `docs/FLUJO-COMMIT-Y-USUARIO-FINAL.md` | Flujo de commit y usuario final (presentación). Adaptar nombres a pos-online si aplica. |
...
POS_ONLINE="/Users/wallfacer/proyectos-gitlab/pos-online"

cp "$TOOLKIT/deploy/dashboard-demo-jenkins-registry.html" "$POS_ONLINE/deploy/dashboard.html"
cp "$TOOLKIT/docs/pos-online/FLUJO-COMMIT-Y-USUARIO-FINAL.md" "$POS_ONLINE/docs/FLUJO-COMMIT-Y-USUARIO-FINAL.md"
...
|-----------|--------------|
| [Instalar Jenkins](INSTALAR-JENKINS.md) | Requisitos, instalación, credenciales, job Pipeline. |
| [Cómo probar](COMO-PROBAR.md) | Pipeline en local, en Jenkins, comprobar la aplicación. |
| [Cómo presentar al cliente](COMO-PRESENTAR-AL-CLIENTE.md) | Mensajes clave, demo, beneficios. |
...
Ejecutar desde **pos-online** (`/Users/wallfacer/proyectos-gitlab/pos-online`):
...
- Guía completa: **docs/pos-online/POS-ONLINE-IMPLEMENTACION-JENKINS-REGISTRY-DEMO.md**
- Índice: **docs/README.md**; en pos-online usar este checklist y **docs/pos-online/POS-ONLINE-IMPLEMENTAR-JENKINS-REGISTRY-DEMO.md**.
