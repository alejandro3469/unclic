...
→ **[GUIA-AWS-GRATIS-INSTALAR-VER-USAR-PROBAR.md](../GUIA-AWS-GRATIS-INSTALAR-VER-USAR-PROBAR.md)** (en `docs/`)
...
- **Pipeline y registry:** docs/pipeline-y-registry/
- **Instalación:** docs/instalacion/INSTALAR-JENKINS.md, REQUISITOS.md
- **Copia del proyecto:** docs/copia/COPIA-POS-ONLINE-FASTFLOW.md
