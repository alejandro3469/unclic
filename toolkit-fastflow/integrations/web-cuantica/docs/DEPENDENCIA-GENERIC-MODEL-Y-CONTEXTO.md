...
```
<carpeta-padre>/
  pos-online/          ← repo pos-online (donde se integra esta implementación FastFlow)
...
Referencias en este repo: **docs/pos-online/** (checklist, flujo commit, implementación demo), **docs/instalacion/**, **docs/pipeline-y-registry/**.
