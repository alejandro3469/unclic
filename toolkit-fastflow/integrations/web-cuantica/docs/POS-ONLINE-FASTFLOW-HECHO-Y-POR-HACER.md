...
| 10 | Probar / “interfaz” del registry | [COMO-PROBAR-REGISTRY.md](COMO-PROBAR-REGISTRY.md): URLs `.../v2/_catalog` y `.../v2/pos-online/tags/list`; dashboard `deploy/dashboard-demo-jenkins-registry.html`. |
...
| Qué | Dónde |
|-----|-------|
| Servidores (Jenkins, Gitea, Vantive) | [SERVIDORES-UNCLIC-Y-LEVANTAR-VANTIVE.md](SERVIDORES-UNCLIC-Y-LEVANTAR-VANTIVE.md) |
