...
Todo esto está detallado en: **[PRIMEROS-PASOS-CUENTA-AWS-NUEVA.md](../00-inicio/PRIMEROS-PASOS-CUENTA-AWS-NUEVA.md)** (secciones 2 y 3).
...
1. **Requisitos:** Cuenta AWS, Terraform ≥ 1.6, AWS CLI configurado (`aws configure`).  
   Si acabas de recuperar acceso: [PRIMEROS-PASOS-CUENTA-AWS-NUEVA.md](../00-inicio/PRIMEROS-PASOS-CUENTA-AWS-NUEVA.md).
...
- En el registrador (Namecheap → Advanced DNS) creas registros **A** que apunten subdominios a las **IP públicas** de tus EC2 (Jenkins, Gitea, POS, landing, etc.).
...
| Objetivo | Documento |
|----------|-----------|
| **Entrar de nuevo / configurar usuario y CLI** | [PRIMEROS-PASOS-CUENTA-AWS-NUEVA.md](../00-inicio/PRIMEROS-PASOS-CUENTA-AWS-NUEVA.md) |
