...
|------|------------------------|----------------|----------------------|
| **pos-online** | `<RUTA_MONOREPO>/toolkit-fastflow/integrations/web-cuantica/repo-pos-fastflow` | `origin` | `http://gitea.<TU_DOMINIO>:3000/TU_USUARIO/pos-online.git` |
| **smartbussiness-generic-model** | `<RUTA_MONOREPO>/toolkit-fastflow/integrations/web-cuantica/smartbussiness-generic-model` | `gitea` | `http://gitea.<TU_DOMINIO>:3000/TU_USUARIO/smartbussiness-generic-model.git` |
