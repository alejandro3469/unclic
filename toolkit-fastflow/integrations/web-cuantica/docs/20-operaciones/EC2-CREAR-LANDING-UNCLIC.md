...
Guía para añadir **una instancia EC2** (Free Tier) para una **landing** (ej. `landing.<TU_DOMINIO>` o `www`).
...
|----------|------------------------|-----------|-----|
| Landing | **fastflow-landing-unclic** | 22 (SSH), 80 (HTTP), 443 (HTTPS opcional) | Página estática / hub |
