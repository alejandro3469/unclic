...
| **Tags de pos-online** | http://localhost:5000/v2/../60-pos-online/tags/list | http://**18.119.157.22**:5000/v2/../60-pos-online/tags/list |
...
curl -s http://localhost:5000/v2/../60-pos-online/tags/list
```
...
curl -s http://18.119.157.22:5000/v2/../60-pos-online/tags/list
```
...
| **Ver tags de pos-online** | Abre `http://<IP-EC2>:5000/v2/../60-pos-online/tags/list`. |
...
| **Probar desde terminal** | `curl -s http://<host>:5000/v2/_catalog` y `curl -s http://<host>:5000/v2/../60-pos-online/tags/list`. |
