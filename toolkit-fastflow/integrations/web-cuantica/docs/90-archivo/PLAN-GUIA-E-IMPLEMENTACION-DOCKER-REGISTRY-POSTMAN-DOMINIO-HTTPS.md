...
| A.2.8 | Incluir: cómo **comprobar** que la imagen se subió (`curl .../v2/_catalog`, `.../v2/../60-pos-online/tags/list`). | Sin referencias a dominios propios. |
...
| B.2.2 | **Registry:** Con REGISTRY=localhost:5000 (o tu valor), comprobar que la imagen aparece en `curl http://localhost:5000/v2/_catalog` y `.../v2/../60-pos-online/tags/list`. | Tags visibles (build number y latest). |
