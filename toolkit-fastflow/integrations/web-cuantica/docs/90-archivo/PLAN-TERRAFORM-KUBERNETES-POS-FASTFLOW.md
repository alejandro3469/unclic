...
| Tema | Documento |
|------|-----------|
| Flujo completo Gitea/Jenkins/POS | [REPLICAR-FLUJO-COMPLETO-GITEA-JENKINS-POS-AWS.md](../20-operaciones/REPLICAR-FLUJO-COMPLETO-GITEA-JENKINS-POS-AWS.md) |
| Deploy POS en otro servidor (Docker/registry) | [ELEMENTOS-Y-PIPELINE-DEPLOY-OTRO-SERVIDOR.md](../../repo-pos-fastflow/ELEMENTOS-Y-PIPELINE-DEPLOY-OTRO-SERVIDOR.md) |
| Terraform POS (cluster existente) | [deploy/terraform/README.md](../../repo-pos-fastflow/deploy/terraform/README.md) |
| K8s YAML POS | [deploy/k8s/README.md](../../repo-pos-fastflow/deploy/k8s/README.md) |
