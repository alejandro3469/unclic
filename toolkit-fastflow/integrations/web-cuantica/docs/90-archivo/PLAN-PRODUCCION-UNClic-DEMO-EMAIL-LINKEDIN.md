...
Referencias: [PLAN-DEMO-DEVOPS-POS-INSTANCIA-DEDICADA-Y-EMAIL-GATE.md](PLAN-DEMO-DEVOPS-POS-INSTANCIA-DEDICADA-Y-EMAIL-GATE.md), [SUBIR-SITIO-A-UNCLIC-CONSULTING.md](../../unclic/docs/SUBIR-SITIO-A-UNCLIC-CONSULTING.md), [GITEA-JENKINS-HTTPS-USUARIO-POS-Y-LINK-DEMO.md](../20-operaciones/GITEA-JENKINS-HTTPS-USUARIO-POS-Y-LINK-DEMO.md), [PLAN-SUBDOMINIO-LANDING-DEMOS-UNCLIC.md](PLAN-SUBDOMINIO-LANDING-DEMOS-UNCLIC.md).
...
1. **DNS (Namecheap):** A **@** y **www** → IP pública de la EC2 donde sirves el **landing** (Nginx u otro), ej. `<IP_LANDING>`.
...
- **Usuario invitado:** solo lectura (ver [GITEA-JENKINS-HTTPS-USUARIO-POS-Y-LINK-DEMO.md](../20-operaciones/GITEA-JENKINS-HTTPS-USUARIO-POS-Y-LINK-DEMO.md)).
...
- **Qué ven:** que usáis **open source** (Terraform, Pulumi, SST). Opciones:
  - Enlaces desde `/demo` (o hub) a **docs** en el repo (ej. `docs/50-tecnologias/TERRAFORM.md`, `PULUMI.md`, `SST.md`) o a repos públicos donde tengáis ejemplos.
...
Configuración de usuarios invitado: [GITEA-JENKINS-HTTPS-USUARIO-POS-Y-LINK-DEMO.md](../20-operaciones/GITEA-JENKINS-HTTPS-USUARIO-POS-Y-LINK-DEMO.md).
...
| Usuario invitado Jenkins/Gitea | [GITEA-JENKINS-HTTPS-USUARIO-POS-Y-LINK-DEMO.md](../20-operaciones/GITEA-JENKINS-HTTPS-USUARIO-POS-Y-LINK-DEMO.md) |
