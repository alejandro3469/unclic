...
| 1.2.5 | Configurar Nginx: `server_name pos.unclic.consulting`; `proxy_pass http://127.0.0.1:8111` (o el puerto donde corra el JAR/contenedor) | `/etc/nginx/conf.d/pos.conf` | Ver [HTTPS-UNCLIC-GITEA-JENKINS](HTTPS-UNCLIC-GITEA-JENKINS.md) como referencia de proxy |
...
Referencia: [POS-ONLINE-JENKINS-INSTALAR-DOCKER-EC2](POS-ONLINE-JENKINS-INSTALAR-DOCKER-EC2.md), [REPLICAR-POS-ONLINE-FASTFLOW-COMPLETO](REPLICAR-POS-ONLINE-FASTFLOW-COMPLETO.md).
...
- Asegurar que existen **usuarios invitado** en ambos con acceso solo a repos/jobs del POS (ver [GITEA-JENKINS-HTTPS-USUARIO-POS-Y-LINK-DEMO](GITEA-JENKINS-HTTPS-USUARIO-POS-Y-LINK-DEMO.md)).
...
- Referencia: [GITEA-JENKINS-HTTPS-USUARIO-POS-Y-LINK-DEMO](GITEA-JENKINS-HTTPS-USUARIO-POS-Y-LINK-DEMO.md).
...
Referencias: [CAPITULO-DESPLIEGUE-OPERACION-AWS](CAPITULO-DESPLIEGUE-OPERACION-AWS.md), [DESPLEGAR-AWS-GRATIS-Y-TRANSFERIR-REPO](DESPLEGAR-AWS-GRATIS-Y-TRANSFERIR-REPO.md).
...
| 4.2.3 | Registry de imágenes: ya documentado en el repo; el pipeline puede construir imagen, push a registry y desplegar en K8s | [COMO-PROBAR-REGISTRY](COMO-PROBAR-REGISTRY.md), [BUILD-REGISTRY-FASTFLOW](pipeline-y-registry/BUILD-REGISTRY-FASTFLOW.md) |
...
| Usuario invitado y enlaces demo | [GITEA-JENKINS-HTTPS-USUARIO-POS-Y-LINK-DEMO](GITEA-JENKINS-HTTPS-USUARIO-POS-Y-LINK-DEMO.md) |
| HTTPS Gitea/Jenkins | [HTTPS-UNCLIC-GITEA-JENKINS](HTTPS-UNCLIC-GITEA-JENKINS.md) |
| Replicar POS FastFlow completo | [REPLICAR-POS-ONLINE-FASTFLOW-COMPLETO](REPLICAR-POS-ONLINE-FASTFLOW-COMPLETO.md) |
| Deploy POS con Jenkins en EC2 | [POS-ONLINE-JENKINS-INSTALAR-DOCKER-EC2](POS-ONLINE-JENKINS-INSTALAR-DOCKER-EC2.md) |
