...
**Instalar desde cero (guía del repo):** [../30-instalacion/GUIA-PONER-JENKINS.md](../30-instalacion/GUIA-PONER-JENKINS.md).
...
1. **Requisitos:** EC2 con Java 17 (Corretto recomendado), puerto 8080 abierto en el security group. Ver [../30-instalacion/REQUISITOS.md](../30-instalacion/REQUISITOS.md) y [../30-instalacion/INSTALAR-JENKINS.md](../30-instalacion/INSTALAR-JENKINS.md).
...
URLs de referencia (actualizar IP según [../20-operaciones/URLS-Y-EC2-PRUEBAS.md](../20-operaciones/URLS-Y-EC2-PRUEBAS.md)):
...
- [Instalación detallada Jenkins](../30-instalacion/INSTALAR-JENKINS.md)
- [Requisitos (Java, Maven, Docker)](../30-instalacion/REQUISITOS.md)
- [Pantallas Jenkins (New Item, Configure)](../20-operaciones/JENKINS-JOB-PANTALLAS-NEW-ITEM-Y-CONFIGURE.md)
- [Tutorial de replicación visual](../90-archivo/REPLICAR-TUTORIAL-VISUAL.md) — pasos con consola, qué ves, comandos y ayudas visuales.
