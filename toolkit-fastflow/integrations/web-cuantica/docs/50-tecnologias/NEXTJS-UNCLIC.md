...
UnClic puede combinar **Next.js**, **shadcn/ui**, patrones de **audio/orb** (inspiración o componentes tipo ElevenLabs) y, opcionalmente, bloques de **Shadcnblocks** para secciones de marketing. La documentación de **Cloudcraft** y variables `NEXT_PUBLIC_*` sigue en [unclic/README.md](../../unclic/README.md) y [DOMINIO-NAMECHEAP-UNCLIC-EC2.md](../20-operaciones/DOMINIO-NAMECHEAP-UNCLIC-EC2.md).
