...
### 3.1 En la EC2 de **Gitea** (18.223.114.68)
...
En **Ubuntu/Debian** (ejemplo histórico con IP 3.15.4.160):
...
Referencias: [DOMINIO-NAMECHEAP-UNCLIC-EC2.md](DOMINIO-NAMECHEAP-UNCLIC-EC2.md), [PLAN-DEMO-POS-FASTFLOW-WEB-CUANTICA.md](PLAN-DEMO-POS-FASTFLOW-WEB-CUANTICA.md).
