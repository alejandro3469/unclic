...
| Namecheap UI | HOST RECORDS: A Record **jenkins** → IP de EC2 Jenkins; **gitea** → IP Gitea; **pos** → IP POS; **@** / **www** → IP Vantive (o la que uses) |

Ver [DOMINIO-NAMECHEAP-UNCLIC-EC2](../DOMINIO-NAMECHEAP-UNCLIC-EC2.md) para la estructura completa de la UI (pestañas Domain, Sharing & Transfer, Advanced DNS), valores actuales y tabla de registros.
