...
Todas estas tecnologías se usan para **automatizar** el flujo de desarrollo y despliegue (Pipeline as Code, CI/CD) usando **solo open source** (o estándares abiertos). El tutorial de replicación completo está en [../REPLICAR-TUTORIAL-VISUAL.md](../REPLICAR-TUTORIAL-VISUAL.md).
