...
- **Repositories:** Sección con filtros **Repository** | **Organization**. Contador (ej. Repositories 7). Pestañas **All** | **7 Sources** | Forks | Mirrors | Collaborative. Lista de repos: `usuario/pos-online-fastflow`, `usuario/pos-online`, `usuario/nucleic`, `usuario/vantive`, `usuario/smartbussiness-generic-model-fastflow`, `usuario/fastflow-integration`, `usuario/smartbussiness-generic-model`.
...
1. **Requisitos:** EC2 con Docker (o binario Linux). Ver [../INSTALAR-GITEA-SELF-HOSTED.md](../INSTALAR-GITEA-SELF-HOSTED.md).
...
- [Instalar Gitea self-hosted](../INSTALAR-GITEA-SELF-HOSTED.md)
- [Clonar pos-online y conectar a Gitea](../CLONAR-POS-ONLINE-Y-CONECTAR-GITEA.md)
- [Repos locales y Gitea](../REPOS-LOCALES-Y-GITEA.md)
