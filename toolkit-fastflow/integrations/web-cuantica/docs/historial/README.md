...
# Guardar en esta carpeta (docs/historial/)
git show 5dfdc92:toolkit-fastflow/integrations/web-cuantica/docs/<nombre-del-archivo> > docs/historial/<nombre-del-archivo>
```

## Lista de docs y commit

La lista completa de rutas y el commit de referencia está en **[COMPATIBILIDAD-Y-HISTORIAL.md](../COMPATIBILIDAD-Y-HISTORIAL.md)** (sección 2). Ahí se indica el commit `5dfdc92` y cada ruta para recuperar (AGENTES-FASTFLOW-REGISTRY-EMPAQUETADO.md, TAREA-FASTFLOW-REGISTRY-Y-EMPAQUETADO.md, HANDOFF-GEORGE-..., etc.).
